-- Migración: Optimización de Actividad Reciente y limpieza de modelo legacy

-- 1. Crear la función RPC para reemplazar recent_activity_view
...
-- 2. Eliminar la vista que ya no se utilizará para que podamos eliminar dependencias
DROP VIEW IF EXISTS public.recent_activity_view;

-- 3. Eliminar la tabla legacy "AccountingAccount"
