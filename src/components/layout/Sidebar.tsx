...
import { LayoutDashboard, Building2, GitBranch, Layers, FolderTree, FileText, Activity, Users, ShieldCheck, Wallet, BarChart3, TrendingUp, BookOpen } from "lucide-react"
...
const navigation = [
  ...
  { name: "Sucursales", href: "/dashboard/sucursales", icon: GitBranch, roles: ["SUPER_ADMIN", "COMPANY_ADMIN"] },
  { name: "Plan de Cuentas", href: "/dashboard/cuentas/mapeo", icon: BookOpen, roles: ["SUPER_ADMIN", "COMPANY_ADMIN"] },
  { name: "Presupuestos", href: "/dashboard/presupuestos", icon: Layers, roles: ["SUPER_ADMIN", "COMPANY_ADMIN"], prefetch: true },
  { name: "Facturas", href: "/dashboard/facturas", icon: FileText, prefetch: true },
  { name: "Ingresos", href: "/dashboard/ingresos", icon: Wallet, prefetch: true },
...
// Server Component puro — recibe userRole como prop desde el layout (sin llamada extra a auth())
