    ...
    const handleAddMapping = async () => {
        ...
        startTransition(async () => {
            try {
                ...
                // Enriquecer el resultado localmente para mostrarlo en la tabla sin refrescar todo
                                ...
                                <tr key={m.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20 transition-colors group">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col">
                                            <span className="text-[10px] font-black text-emerald-500 uppercase tracking-tighter">{m.account?.code}</span>
                                            <span className="text-sm font-black text-foreground">{m.account?.name}</span>
                                        </div>
                                    </td>
