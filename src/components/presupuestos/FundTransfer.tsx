                    ...
                    <div className="space-y-1.5">
                        ...
                        >
                            <option value="">Selecciona origen...</option>
                             {allocations.map(a => (
                                <option key={a.id} value={a.id.toString()}>{a.category?.name || 'S/C'} (${Number(a.amountUSD).toLocaleString()})</option>
                            ))}
                        </select>
                    </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        >
                            <option value="">Selecciona destino...</option>
                             {allocations.map(a => (
                                <option key={a.id} value={a.id.toString()}>{a.category?.name || 'S/C'}</option>
                            ))}
                        </select>
                    </div>
                </div>
